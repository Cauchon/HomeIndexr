...
import { useState as useState_chart, useMemo as useMemo_chart, useRef as useRef_chart, useEffect as useEffect_chart } from "react";
...
export function PriceChart({ current, historical = [], height = 280 }) {
