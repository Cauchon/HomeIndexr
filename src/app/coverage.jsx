...
//
// All data flows through the API client; no client-side scraping. The coverage
...
//
// Exports: CoverageSection, AddZipModal, RemoveZipModal.

import { useState as cvS, useEffect as cvE, useMemo as cvM } from "react";
import { API } from "./api.js";
import { Icon, fmt, useToast } from "./components.jsx";

// ---------- stats ----------
export function coverageStats(coverage) {
...
// ============================================================
export function AddZipModal({ existing, onClose, onAdded }) {
...
//   REMOVE ZIP MODAL
// ============================================================
export function RemoveZipModal({ record, onClose, onConfirm }) {
  return (
